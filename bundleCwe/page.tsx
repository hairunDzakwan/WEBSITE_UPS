...
import styles from '@/app/bundleCwe/styles.module.css';
...
function Page() {
 ...
 const [showDialog, setShowDialog] = useState(false);
  ...
  const produkId = 36; // ID produk Paket Laki-Laki
  ...
  if (!produk) return <p className="text-center mt-10">Memuat...</p>;

  // Menyaring ukuran berdasarkan kategori
  const ukuranCelanaList = produk.ukurans.filter(uk => uk.kategori === 'rok');
    ...
    <div className="h-screen">
      ...
      <div className="flex flex-col lg:flex-row lg:pr-10 gap-0">
        ...
        <div className="lg:ml-10 self-center px-5">
          ...
          <h1 className="text-5xl font-extrabold mb-2">{produk.nama}</h1>
          <p className="text-xs text-gray-600">Almamater, Baju Putih, Baju Batik, Baju Pramuka, Baju Praktek, Baju Olahraga, Baju SKJ,   </p>
          <p className="text-xs text-gray-600">Rok Abu-Abu, Rok Pramuka, Rok Olahraga, Dasi, Topi, dan Lambang Baju </p>
          ...
          {/* Ukuran Celana */}
          <p className="text-gray-600 text-2xl font-medium">Ukuran Bawahan</p>
          <div className="flex flex-wrap gap-2">
