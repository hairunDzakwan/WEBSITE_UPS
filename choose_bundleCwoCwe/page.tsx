...
import PaketCwo from '@/app/public/BundleCwo (2).png' 
import PaketCwe from '@/app/public/BundleCwe (1).png' 
...
function page() {
  return (
    ...
    <div className={styles.baju}>
      <Link href="/bundleCwo">
    <Image src={PaketCwo} alt='logo' width={550} quality={100} className={styles.lk} />
    </Link>
    <Link href="/bundleCwe">
    <Image src={PaketCwe} alt='logo' width={575} quality={100} className={styles.pr}/>
    </Link>
    </div>
    </div>
  </div>
