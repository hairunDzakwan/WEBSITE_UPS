...
import styles from '@/app/lakipraktek/styles.module.css';
...
import bjupraktek from '@/app/public/lakipraktek.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={bjupraktek} alt="almamater" width={600} quality={100} />
          </div>
          ...
          <div className="lg:ml-10 self-center px-5">
            ...
            <h1 className="text-4xl font-bold mb-7 text-red-700">Rp 150.000</h1>
