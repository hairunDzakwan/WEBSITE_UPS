...
import rokAbu from '@/app/public/rokabuhrga.png'
import rokPramuka from '@/app/public/rokpramkhrga.png'
import rokOlga from '@/app/public/clnaolgacwehrga.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={rokPramuka} alt="rok pramuka" width={600} quality={100} />
          </div>
          ...
          <div className="lg:ml-10 self-center px-5">
            ...
            <h1 className="text-5xl font-extrabold mb-7">Rok Pramuka</h1>
