...
import abu from '@/app/public/clnaaabuharga.png'
import prmk from '@/app/public/clnapramukaharga.png'
import olga from '@/app/public/clnaolgacwohrga.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={olga} alt="clna olhrg" width={600} quality={100} />
          </div>
          ...
          <div className="lg:ml-10 self-center px-5">
            ...
            <h1 className="text-5xl font-extrabold mb-7">Celana Olahraga</h1>
