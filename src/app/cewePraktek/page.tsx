...
import praktek from '@/app/public/praktekpr.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={praktek} alt="praktek" width={600} quality={100} />
          </div>
          ...
          <div className="lg:ml-10 self-center px-5">
            ...
            <h1 className="text-5xl font-extrabold mb-7">Baju Praktek</h1>
