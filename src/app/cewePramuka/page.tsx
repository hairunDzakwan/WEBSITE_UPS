...
import bjupramuka from '@/app/public/pramukapr.png'
import praktek from '@/app/public/pramukapr.png'
import alma from '@/app/public/pramukapr.png'
import batik from '@/app/public/batikpr.png'
import putih from '@/app/public/putihpr.png'
import olga from '@/app/public/olahragapr.png'
import skj from '@/app/public/skjpr.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={bjupramuka} alt="pramuka" width={600} quality={100} />
          </div>
          ...
          <div className="lg:ml-10 self-center px-5">
            ...
            <h1 className="text-5xl font-extrabold mb-7">Baju Pramuka</h1>
