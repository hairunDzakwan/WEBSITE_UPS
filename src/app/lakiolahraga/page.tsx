...
import styles from '@/app/lakiolahraga/styles.module.css';
...
import bjuolahraga from '@/app/public/lakiolahraga.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={bjuolahraga} alt="almamater" width={600} quality={100} />
          </div>
