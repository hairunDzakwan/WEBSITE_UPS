...
import bjupramuka from '@/app/public/lakipramuka.png'
      ...
      <div className="h-screen">
        ...
        <div className="flex flex-col lg:flex-row lg:pr-10  gap-5">
          ...
          <div className="flex justify-center lg:ml-16">
            <Image src={lbgsmktelkomcoklat} alt="TelkomCoklat" width={600} quality={100} />
          </div>
          ...
          <div className="lg:ml-10 self-center px-5">
            ...
            <h1 className="text-5xl font-extrabold mb-7">Lambang SMK Telkom Pramuka</h1>

            {/* Harga Pesanan */}
            <p className="text-gray-600 text-2xl font-medium">Harga Pesanan</p>
            <h1 className="text-4xl font-bold mb-7 text-red-700">Rp 5.000</h1>
